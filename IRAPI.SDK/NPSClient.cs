...
namespace IRAPI.SDK
{
    public class NPSClient
    {
        ...
        static public string ApiEndpointURL = "https://api.delighted.com/";
        public string ClientInfo { get; set; } 
        public string AccessToken { get; set; } 
        public string ApiUser { get; set; }
        public string ApiPassword { get; set; }

        public NPSClient(string client) {
            this.ClientInfo = client;
        }

        public NPSClient(string client, string user, string password)
        {
            this.ClientInfo = client;
            this.ApiUser = user;
        ...
        private RestRequest Prepare(Method method, string path, object obj = null)
        {
            ...
            request.AddParameter("Authorization", string.Format("Basic {0}", this.ApiUser), ParameterType.HttpHeader);
            if (obj != null)
            {
        ...
        {
            var client = new RestClient(NPSClient.ApiEndpointURL);
