...
namespace IRLib
{
    ...
    public abstract class VendaBilheteria_B : BaseBD
    {
        ...
        public vendabilheteriaidtroca VendaBilhereriaIDTroca = new vendabilheteriaidtroca();

        public vendabilheteriaidorigem VendaBilheteriaIDOrigem = new vendabilheteriaidorigem();

        public codigorastreio CodigoRastreio = new codigorastreio();

        public entregacancelada EntregaCancelada = new entregacancelada();

        public convenienciacancelada ConvenienciaCancelada = new convenienciacancelada();

        public segurocancelado SeguroCancelado = new segurocancelado();
        ...
        public override void Ler(int id)
        {
            ...
            try
            {
                ...
                if (bd.Consulta().Read())
                {
                    ...
                    this.VendaBilheteriaIDOrigem.ValorBD = bd.LerInt("VendaBilheteriaIDOrigem").ToString();

                    this.CodigoRastreio.ValorBD = bd.LerString("CodigoRastreio");

                    this.EntregaCancelada.ValorBD = bd.LerString("EntregaCancelada");
                    this.ConvenienciaCancelada.ValorBD = bd.LerString("ConvenienciaCancelada");
                    this.SeguroCancelado.ValorBD = bd.LerString("SeguroCancelado");

					this.AgregadoNome = bd.LerString("AgregadoNome");
					this.AgregadoCPF = bd.LerString("AgregadoCPF");
					this.AgregadoEmail = bd.LerString("AgregadoEmail");
					this.AgregadoTelefone = bd.LerString("AgregadoTelefone");
        ...
        public void LerSenhaCompra(string compra)
        {
            LerSenhaCompra(bd, compra);

            bd.Fechar();
        }
		public void LerSenhaCompra(BD bd, string compra)
		{

			try
			{

				string sql = "SELECT * FROM tVendaBilheteria WHERE Senha = '" + compra + "'";
				bd.Consulta(sql);
        ...
        public override bool Inserir()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO tVendaBilheteria(ID, CaixaID, ClienteID, Senha, DataVenda, Status, TaxaEntregaID, TaxaConvenienciaValorTotal, ComissaoValorTotal, ValorTotal, Obs, NotaFiscalCliente, NotaFiscalEstabelecimento, IndiceInstituicaoTransacao, IndiceTipoCartao, NSUSitef, NSUHost, CodigoAutorizacaoCredito, BIN, ModalidadePagamentoCodigo, ModalidadePagamentoTexto, DDD, NumeroCelular, ModelIDCelular, FabricanteCelular, NivelRisco, IP, Fraude, AprovacaoAutomatica, QuantidadeImpressoesInternet, VendaCancelada, MotivoID, ClienteEnderecoID, EntregaControleID, EntregaAgendaID, PdvID, TaxaEntregaValor, PagamentoProcessado, NomeCartao, ValorSeguro, TaxaProcessamentoValor, TaxaProcessamentoCancelada, Score, RetornoAccertify, AccertifyForceStatus, VendaBilhereriaIDTroca, CodigoRastreio, EntregaCancelada, ConvenienciaCancelada, SeguroCancelado,  VendaBilheteriaIDOrigem) ");
                ...
                sql.Replace("@047", this.EntregaCancelada.ValorBD);

                sql.Replace("@048", this.ConvenienciaCancelada.ValorBD);

                sql.Replace("@049", this.SeguroCancelado.ValorBD);

                sql.Replace("@050", this.VendaBilheteriaIDOrigem.ValorBD);
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
				...
				sql.Replace("@051", this.AgregadoNome);

				sql.Replace("@052", this.AgregadoCPF);

				sql.Replace("@053", this.AgregadoEmail);

				sql.Replace("@054", this.AgregadoTelefone);
        ...
        public override bool Atualizar(BD bd)
        {
            ...
            try
            {
                ...
                sql.Append("UPDATE tVendaBilheteria SET CaixaID = @001, ClienteID = @002, Senha = '@003', DataVenda = '@004', Status = '@005', TaxaEntregaID = @006, TaxaConvenienciaValorTotal = '@007', ComissaoValorTotal = '@008', ValorTotal = '@009', Obs = '@010', NotaFiscalCliente = '@011', NotaFiscalEstabelecimento = '@012', IndiceInstituicaoTransacao = @013, IndiceTipoCartao = @014, NSUSitef = @015, NSUHost = @016, CodigoAutorizacaoCredito = @017, BIN = @018, ModalidadePagamentoCodigo = @019, ModalidadePagamentoTexto = '@020', DDD = @021, NumeroCelular = @022, ModelIDCelular = @023, FabricanteCelular = '@024', NivelRisco = @025, IP = '@026', Fraude = @027, AprovacaoAutomatica = '@028', QuantidadeImpressoesInternet = @029, VendaCancelada = '@030', MotivoID = @031, ClienteEnderecoID = @032, EntregaControleID = @033, EntregaAgendaID = @034, PdvID = @035, TaxaEntregaValor = '@036', PagamentoProcessado = '@037', NomeCartao = '@038', ValorSeguro = '@039', TaxaProcessamentoValor = '@040', TaxaProcessamentoCancelada = '@041', Score = @042, RetornoAccertify = '@043', AccertifyForceStatus = '@044', VendaBilhereriaIDTroca = @045, CodigoRastreio = '@046', EntregaCancelada = '@047', ConvenienciaCancelada = '@048', SeguroCancelado = '@049', VendaBilheteriaIDOrigem = @050 ");
                sql.Append("WHERE ID = @ID");
                sql.Replace("@ID", this.Control.ID.ToString());
        ...
        public override void Limpar()
        {
            ...
            this.EntregaCancelada.Limpar();

            this.ConvenienciaCancelada.Limpar();

            this.SeguroCancelado.Limpar();

            this.VendaBilheteriaIDOrigem.Limpar();
        ...
        public override void Desfazer()
        {
            ...
            this.EntregaCancelada.Desfazer();

            this.ConvenienciaCancelada.Desfazer();

            this.SeguroCancelado.Desfazer();

            this.VendaBilheteriaIDOrigem.Desfazer();
        ...
        public class vendabilheteriaidtroca : IntegerProperty
        {
        ...
        public class vendabilheteriaidorigem : IntegerProperty
        {
            ...
            public override string Nome
            {
                get
                {
                    return "VendaBilheteriaIDOrigem";
                }
            }
        ...
        public class entregacancelada : BooleanProperty
        {
        ...
        public class convenienciacancelada : BooleanProperty
        {
        ...
        public class segurocancelado : BooleanProperty
        {
        ...
        public static DataTable Estrutura()
        {
            ...
            try
            {
                ...
                tabela.Columns.Add("EntregaCancelada", typeof(bool));

                tabela.Columns.Add("ConvenienciaCancelada", typeof(bool));

                tabela.Columns.Add("SeguroCancelado", typeof(bool));
            ...
            try
            {
                ...
                if (this.Primeiro())
                {
                    ...
                    do
                    {
                        ...
                        linha["EntregaCancelada"] = vendaBilheteria.EntregaCancelada.Valor;

                        linha["ConvenienciaCancelada"] = vendaBilheteria.ConvenienciaCancelada.Valor;

                        linha["SeguroCancelado"] = vendaBilheteria.SeguroCancelado.Valor;
            ...
            try
            {
                ...
                switch (campo)
                {
                    ...
                    case "CodigoRastreio":
                        ...
                        break;
                    case "EntregaCancelada":
                        sql = "SELECT ID, EntregaCancelada FROM tVendaBilheteria WHERE " + FiltroSQL + " ORDER BY EntregaCancelada";
                        break;
                    case "ConvenienciaCancelada":
                        sql = "SELECT ID, ConvenienciaCancelada FROM tVendaBilheteria WHERE " + FiltroSQL + " ORDER BY ConvenienciaCancelada";
                        break;
                    case "SeguroCancelado":
                        sql = "SELECT ID, SeguroCancelado FROM tVendaBilheteria WHERE " + FiltroSQL + " ORDER BY SeguroCancelado";
                        break;
