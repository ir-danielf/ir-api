    ...
    public abstract class Setor_B : BaseBD
    {
        ...
        protected void InserirLog()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO xSetor (ID, Versao, LocalID, Nome, Acesso, NomeInterno, LugarMarcado, Produto, ObservacaoImportante, DistanciaPalco, AprovadoPublicacao, VersaoBackground, CodigoSala, Capacidade, Linhas, Colunas, Ativo) ");
                sql.Append("SELECT ID, @V, LocalID, Nome, Acesso, NomeInterno, LugarMarcado, Produto, ObservacaoImportante, DistanciaPalco, AprovadoPublicacao, VersaoBackground, CodigoSala, Capacidade, Linhas, Colunas, Ativo FROM tSetor WHERE ID = @I");
        ...
        public override bool Inserir()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO tSetor(ID, LocalID, Nome, Acesso, NomeInterno, LugarMarcado, Produto, ObservacaoImportante, DistanciaPalco, AprovadoPublicacao, VersaoBackground, CodigoSala, Capacidade, Linhas, Colunas, Ativo) ");
                ...
                if (this.VersaoBackground.ValorBD != String.Empty)
                {
                    versaoBackground = Convert.ToInt32(Convert.ToInt32(this.VersaoBackground.ValorBD) + 1);
                }
                sql.Replace("@010", versaoBackground.ToString());
                ...
                sql.Replace("@015", this.Ativo.ValorBD);
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE tSetor SET LocalID = @001, Nome = '@002', Acesso = '@003', NomeInterno = '@004', LugarMarcado = '@005', Produto = '@006', ObservacaoImportante = '@007', DistanciaPalco = @008, AprovadoPublicacao = '@009', VersaoBackground = @010, CodigoSala = '@011', Capacidade = @012, Linhas = @013, Colunas = @014, Ativo = '@015' ");
            ...
            try
            {
                ...
                switch (campo)
                {
                    ...
                    case "Colunas":
                        ...
                        break;
                    case "Ativo":
                        sql = "SELECT ID, Ativo FROM tSetor WHERE " + FiltroSQL + " ORDER BY Ativo";
                        break;
                    default:
                        sql = null;
                        break;
