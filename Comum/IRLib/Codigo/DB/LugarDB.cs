...
namespace IRLib
{
    ...
    public abstract class Lugar_B : BaseBD
    {
        ...
        public pnetipo PNETipo = new pnetipo();
        public lugaridcadeirante LugarIDCadeirante = new lugaridcadeirante();
        ...
        public override void Ler(int id)
        {
            ...
            try
            {
                ...
                if (bd.Consulta().Read())
                {
                        ...
                        this.PNETipo.ValorBD = bd.LerString("PNETipo");
                        this.LugarIDCadeirante.ValorBD = bd.LerInt("LugarIDCadeirante").ToString();
                }
                else
                {
                    this.Limpar();
        ...
        protected void InserirLog()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO xLugar (ID, Versao, SetorID, Codigo, Quantidade, QuantidadeBloqueada, PosicaoX, PosicaoY, Simbolo, BloqueioID, Classificacao, Grupo, Obs, PerspectivaLugarID, CodigoCinema, PNETipo, LugarIDCadeirante) ");
                sql.Append("SELECT ID, @V, SetorID, Codigo, Quantidade, QuantidadeBloqueada, PosicaoX, PosicaoY, Simbolo, BloqueioID, Classificacao, Grupo, Obs, PerspectivaLugarID, CodigoCinema, PNETipo, LugarIDCadeirante FROM tLugar WHERE ID = @I");
        ...
        public override bool Inserir()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO tLugar(ID, SetorID, Codigo, Quantidade, QuantidadeBloqueada, PosicaoX, PosicaoY, Simbolo, BloqueioID, Classificacao, Grupo, Obs, PerspectivaLugarID, CodigoCinema, PNETipo, LugarIDCadeirante) ");
                ...
                sql.Replace("@014", this.PNETipo.ValorBD);
                sql.Replace("@015", this.LugarIDCadeirante.ValorBD);
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE tLugar SET SetorID = @001, Codigo = '@002', Quantidade = @003, QuantidadeBloqueada = @004, PosicaoX = @005, PosicaoY = @006, Simbolo = @007, BloqueioID = @008, Classificacao = @009, Grupo = @010, Obs = '@011', PerspectivaLugarID = @012, CodigoCinema = '@013', PNETipo = '@014', LugarIDCadeirante = @015 ");
        ...
        public override void Desfazer()
        {
            ...
            this.PNETipo.Desfazer();
            this.LugarIDCadeirante.Desfazer();
        }
        ...
        public class pnetipo : TextProperty
        {
        ...
        public class lugaridcadeirante : IntegerProperty
        {
