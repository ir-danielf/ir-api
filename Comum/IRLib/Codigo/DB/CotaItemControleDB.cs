    ...
    public abstract class CotaItemControle_B : BaseBD
    {
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE tCotaItemControleInMemory SET ApresentacaoID = @001, ApresentacaoSetorID = @002, Quantidade = @003, CotaItemID = @004 ");
                ...
                BD bd2 = new BD();
                int x = bd2.Executar(sql.ToString());
                bd2.Fechar();
