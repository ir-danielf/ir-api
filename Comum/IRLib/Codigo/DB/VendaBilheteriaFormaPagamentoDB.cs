...
namespace IRLib
{
    ...
    public abstract class VendaBilheteriaFormaPagamento_B : BaseBD
    {
        ...
        public vendaBilheteriaFormaPagamentoidOrigem VendaBilheteriaFormaPagamentoIdOrigem = new vendaBilheteriaFormaPagamentoidOrigem();
        ...
        public class vendaBilheteriaFormaPagamentoidOrigem : IntegerProperty
        {
            ...
            public override string Nome
            {
                get
                {
                    return "VendaBilheteriaFormaPagamentoIDOrigem";
                }
            }
