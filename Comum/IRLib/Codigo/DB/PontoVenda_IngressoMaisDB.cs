...
namespace IRLib
{
    ...
    public abstract class PontoVenda_IngressoMais_B : BaseBD
    {
        ...
        public PontoVenda_IngressoMais_B() { }

        // passar o Usuario logado no sistema
        public PontoVenda_IngressoMais_B(int usuarioIDLogado)
        {
        ...
        public override void Ler(int id)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tPontoVenda_IngressoMais WHERE ID = " + id;
                bd.Consulta(sql);
        ...
        public void LerBackup(int id)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM xPontoVenda_IngressoMais WHERE ID = " + id;
                bd.Consulta(sql);
        ...
        protected void InserirControle(string acao)
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO cPontoVenda_IngressoMais (ID, Versao, Acao, TimeStamp, UsuarioID) ");
        ...
        protected void InserirLog()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO xPontoVenda_IngressoMais (ID, Versao, Local, Nome, Endereco, Numero, Compl, Cidade, Estado, Bairro, Obs, Referencia, CEP, PermiteRetirada, IR) ");
                sql.Append("SELECT ID, @V, Local, Nome, Endereco, Numero, Compl, Cidade, Estado, Bairro, Obs, Referencia, CEP, PermiteRetirada, IR FROM tPontoVenda_IngressoMais WHERE ID = @I");
        ...
        public override bool Excluir(int id)
        {
            ...
            try
            {
                ...
                string sqlSelect = "SELECT MAX(Versao) FROM cPontoVenda_IngressoMais WHERE ID=" + this.Control.ID;
                ...
                string sqlDelete = "DELETE FROM tPontoVenda_IngressoMais WHERE ID=" + id;
    ...
    public abstract class PontoVendaLista_IngressoMais_B : BaseLista
    {
        ...
        // passar o Usuario logado no sistema
        public PontoVendaLista_IngressoMais_B()
        {
            pontoVenda = new PontoVenda();
        }

        // passar o Usuario logado no sistema
        public PontoVendaLista_IngressoMais_B(int usuarioIDLogado)
        {
        ...
        public void Carregar(int tamanhoMax)
        {
            ...
            try
            {
                ...
                if (tamanhoMax == 0)
                    sql = "SELECT ID FROM tPontoVenda_IngressoMais";
                else
                    sql = "SELECT top " + tamanhoMax + " ID FROM tPontoVenda_IngressoMais";
        ...
        public void CarregarBackup()
        {
            ...
            try
            {
                ...
                if (tamanhoMax == 0)
                    sql = "SELECT ID FROM xPontoVenda_IngressoMais";
                else
                    sql = "SELECT top " + tamanhoMax + " ID FROM xPontoVenda_IngressoMais";
        ...
        public override IDataReader ListaPropriedade(string campo)
        {
            ...
            try
            {
                ...
                {
                    case "Local":
                        sql = "SELECT ID, Local FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Local";
                        break;
                    case "Nome":
                        sql = "SELECT ID, Nome FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Nome";
                        break;
                    case "Endereco":
                        sql = "SELECT ID, Endereco FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Endereco";
                        break;
                    case "Numero":
                        sql = "SELECT ID, Numero FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Numero";
                        break;
                    case "Compl":
                        sql = "SELECT ID, Compl FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Compl";
                        break;
                    case "Cidade":
                        sql = "SELECT ID, Cidade FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Cidade";
                        break;
                    case "Estado":
                        sql = "SELECT ID, Estado FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Estado";
                        break;
                    case "Bairro":
                        sql = "SELECT ID, Bairro FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Bairro";
                        break;
                    case "Obs":
                        sql = "SELECT ID, Obs FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Obs";
                        break;
                    case "Referencia":
                        sql = "SELECT ID, Referencia FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY Referencia";
                        break;
                    case "CEP":
                        sql = "SELECT ID, CEP FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY CEP";
                        break;
                    case "PermiteRetirada":
                        sql = "SELECT ID, PermiteRetirada FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY PermiteRetirada";
                        break;
                    case "IR":
                        sql = "SELECT ID, IR FROM tPontoVenda_IngressoMais WHERE " + FiltroSQL + " ORDER BY IR";
                        break;
                    default:
                        sql = null;
                        break;
    ...
    [Serializable]
    public class PontoVendaException_IngressoMais : Exception
    {

        public PontoVendaException_IngressoMais() : base() { }

        public PontoVendaException_IngressoMais(string msg) : base(msg) { }

        public PontoVendaException_IngressoMais(SerializationInfo info, StreamingContext context) : base(info, context) { }
