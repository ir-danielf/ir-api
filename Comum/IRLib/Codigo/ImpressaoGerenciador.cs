...
namespace IRLib
{
    ...
    public class ImpressaoGerenciador : MarshalByRefObject
    {
        ...
        public const string AGREGADO_NOME = "AgregadoNome";
        public const string AGREGADO_CPF = "AgregadoCPF";
        public const string AGREGADO_EMAIL = "AgregadoEmail";
        public const string AGREGADO_TELEFONE = "AgregadoTelefone";

        private bool SoImprimirDataApresentacao = new ConfigGerenciador().ImprimirSomenteDataApresentacao();

        //private string login;

        public ImpressaoGerenciador()
        {
        ...
        public static DataTable EstruturaGrid()
        {
            ...
            DataTable tGrid = new DataTable(Bilheteria.TABELA_GRID);

            tGrid.Columns.Add(INGRESSO_ID, typeof(int)).DefaultValue = 0;
            tGrid.Columns.Add(LOG_ID, typeof(int)).DefaultValue = 0;
            tGrid.Columns.Add(Bilheteria.EVENTO, typeof(string));
            tGrid.Columns.Add(Bilheteria.HORARIO, typeof(string));
            tGrid.Columns.Add(Bilheteria.SETOR_PRODUTO, typeof(string));
            tGrid.Columns.Add(Bilheteria.CODIGO, typeof(string));
            tGrid.Columns.Add(Bilheteria.PRECO, typeof(string));
            tGrid.Columns.Add(Bilheteria.CORTESIA, typeof(string));
            tGrid.Columns.Add(Bilheteria.VALOR, typeof(decimal));
        ...
        public static DataTable EstruturaInfoVenda()
        {
            ...
            tGrid.Columns.Add(AGREGADO_NOME, typeof(string)).DefaultValue = "";
            tGrid.Columns.Add(AGREGADO_CPF, typeof(string)).DefaultValue = "";
            tGrid.Columns.Add(AGREGADO_EMAIL, typeof(string)).DefaultValue = "";
            tGrid.Columns.Add(AGREGADO_TELEFONE, typeof(string)).DefaultValue = "";
            return tGrid;
                ...
                if (ingressoLista.Tamanho > 0)
                {
                    ...
                    if (bd.Consulta().Read())
                    {
                        if (bd.LerInt("VendaBilheteriaID") == ingressoLista.Ingresso.VendaBilheteriaID.Valor)
                        {
                            ...
                            linha[AGREGADO_NOME] = bd.LerString(AGREGADO_NOME);
                            linha[AGREGADO_CPF] = bd.LerString(AGREGADO_CPF);
                            linha[AGREGADO_EMAIL] = bd.LerString(AGREGADO_EMAIL);
                            linha[AGREGADO_TELEFONE] = bd.LerString(AGREGADO_TELEFONE);
        ...
        private string MontarBuscaIngressos(string clausula)
        {
            ...
            sb.Append("vb.AgregadoNome, vb.AgregadoCPF, vb.AgregadoEmail, vb.AgregadoTelefone ");
        ...
        public EstruturaRetornoVendaValeIngresso PesquisarCodigoBarrasValeIngresso(string codigoBarra, string login)
        {
            ...
            try
            {
                ...
                if (bd.Consulta().Read())
                {
                    ...
                    retorno.AgregadoNome = bd.LerString(AGREGADO_NOME);
                    retorno.AgregadoCPF = bd.LerString(AGREGADO_CPF);
                    retorno.AgregadoEmail = bd.LerString(AGREGADO_EMAIL);
                    retorno.AgregadoTelefone = bd.LerString(AGREGADO_TELEFONE);
                }
                bd.FecharConsulta();
        ...
        private string MontarBuscaValeIngressos(string clausula)
        {
            ...
            stbSQL.Append("vb.AgregadoNome, vb.AgregadoCPF, vb.AgregadoEmail, vb.AgregadoTelefone ");
