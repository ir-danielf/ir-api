...
namespace IRLib
{
    ...
    public class CodigoBarraEvento : CodigoBarraEvento_B
    {
        ...
        public void GerarCodigos(int apresentacaoSetorID, List<string> codigos, DateTime dataInclusao, int EventoID, BD banco)
        {
            if (codigos.Count == 0)
                return;
        ...
        public void GerarCodigos(int apresentacaoSetorID, List<string> codigos, DateTime dataInclusao, int EventoID)
        {
            GerarCodigos(apresentacaoSetorID, codigos, dataInclusao, EventoID, this.bd);
        }
