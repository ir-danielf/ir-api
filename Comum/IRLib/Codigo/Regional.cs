...
namespace IRLib
{
    ...
    public class Regional : Regional_B
    {
        ...
        public DataTable TodosComEmpresaAtiva()
        {
            return TodosComEmpresaAtiva(null);
        }
        ...
        /// <summary>
        /// Obter todas as regionais com Empresa Ativa
        /// </summary>
        /// <returns></returns>
        public DataTable TodosComEmpresaAtiva(string registroZero)
        {
            try
            {
                DataTable tabela = new DataTable("Regionais");
        ...
        public DataTable EmpresasAtivas(int regionalID, string registroZero)
        {
            DataTable tabela = new DataTable("Empresa");
            tabela.Columns.Add("ID", typeof(int));
            tabela.Columns.Add("Nome", typeof(string));
            if (registroZero != null)
                tabela.Rows.Add(new Object[] { 0, registroZero });
            string sql = "SELECT ID, Nome FROM tEmpresa WHERE Ativo='T' AND RegionalID = " + regionalID + "ORDER BY Nome";
            bd.Consulta(sql);
            while (bd.Consulta().Read())
            {
                DataRow linha = tabela.NewRow();
        ...
        public DataTable EmpresasAtivas(int regionalID)
        {
            return EmpresasAtivas(regionalID, null);
        }
        /// <summary>		
        ...
        public List<IRLib.ClientObjects.EstruturaIDNome> CarregarLista(bool registroZero)
        {
            try
            {
                ...
                if (registroZero)
                    lista.Add(new IRLib.ClientObjects.EstruturaIDNome() { ID = 0, Nome = "Todas" });
        ...
        public List<IRLib.ClientObjects.EstruturaIDNome> CarregarListaComEmpresasAtivas(bool registroZero)
        {
            try
            {
                List<IRLib.ClientObjects.EstruturaIDNome> lista = new List<IRLib.ClientObjects.EstruturaIDNome>();
                ...
                bd.Consulta("SELECT DISTINCT tRegional.ID, tRegional.Nome " +
                            "FROM tRegional (NOLOCK) " +
                            "INNER JOIN tEmpresa ON tRegional.ID = tEmpresa.RegionalID " +
                            "WHERE tEmpresa.Ativo = 'T' " +
                            "ORDER BY tRegional.Nome");
        ...
        /// </summary>
        /// <returns></returns>
        public List<IRLib.EstruturaRegionalEmail> CarregarListaEmail()
        {
            try
            {
                List<IRLib.EstruturaRegionalEmail> lista = new List<IRLib.EstruturaRegionalEmail>();
                ...
                while (bd.Consulta().Read())
                {
                    lista.Add(new IRLib.EstruturaRegionalEmail()
                    {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable EmpresasAtivas(int regionalID, string registroZero, Apresentacao.Disponibilidade disponibilidade)
        {
            ...
            try
            {
                ...
                using (IDataReader oDataReader = bd.Consulta("" +
                    ...
                    "   em.ID = lo.EmpresaID " +
                    "WHERE " +
                    " em.Ativo = 'T' AND (em.RegionalID = " + regionalID + ") " +
                    disponivelVenda +
                    disponivelAjuste +
                    disponivelRelatorio +
                    " ORDER BY " +
