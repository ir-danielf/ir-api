...
namespace IRLib.Assinaturas.Relatorios
{
    public class BorderoResumo
    {
        ...
        public IRLib.Assinaturas.Models.BorderoResumo BuscarRelatorio(int AssinaturaTipoID, int Temporadas, int Assinaturas)
        {
            try
            {
                ...
                while (bd.Consulta().Read())
                {
                    ...
                    retorno.ListaPagantes.Add(new IRLib.Assinaturas.Models.EstruturaPagantes
                    {
                        SetorID = setorID,
                        Setor = setor,
                        Preco = preco,
                    ...
                    else
                    {
                        ...
                        retorno.ListaPagantesSub.Add(new IRLib.Assinaturas.Models.EstruturaPagantesSubtotal
                        {
                            SetorID = setorID,
                            Quantidade = quantidade,
                            Faturamento = faturamento,
                ...
                while (bd.Consulta().Read())
                {
                    retorno.ListaEstatisticaSetor.Add(new IRLib.Assinaturas.Models.EstruturaEstatisticaSetor
                    {
