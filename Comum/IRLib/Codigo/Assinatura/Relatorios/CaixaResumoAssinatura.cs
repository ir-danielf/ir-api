...
namespace IRLib.Assinaturas.Relatorios
{
    public class CaixaResumoAssinatura
    {
        ...
        public IRLib.Assinaturas.Models.CaixaResumoAssinatura   BuscarRelatorio(int AssinaturaTipoID, int Temporadas, int Assinaturas, int Canais, int Lojas, string DataInicial, string DataFinal)
        {
            try
            {
