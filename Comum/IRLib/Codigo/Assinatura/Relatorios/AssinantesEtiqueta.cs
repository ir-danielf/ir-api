...
namespace IRLib.Assinaturas.Relatorios
{
    public class AssinantesEtiqueta
    {
        ...
        public List<IRLib.Assinaturas.Models.Cliente> BuscarRelatorio(int AssinaturaTipoID, int Temporadas, int Assinaturas, bool Email)
        {
            try
            {
                ...
                string sql = @"SELECT DISTINCT c.LoginOSESP, c.Nome, c.CPF, c.Sexo,
