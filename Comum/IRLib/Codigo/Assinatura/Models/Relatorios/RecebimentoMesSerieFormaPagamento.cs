...
namespace IRLib.Assinaturas.Models.Relatorios
{
    ...
    public class RecebimentoPeriodo
    {
        ...
        public IRLib.AssinaturaTipo.EnumPeriodos Periodo { get; set; }
        public string PeriodoExibicao
        {
            get
            {
                switch (Periodo)
                {
                    case IRLib.AssinaturaTipo.EnumPeriodos.Renovacao:
                        return "Renovação";
                    case IRLib.AssinaturaTipo.EnumPeriodos.Troca:
                        return "Troca";
                    case IRLib.AssinaturaTipo.EnumPeriodos.Aquisicao:
                        return "Novas aquisições";
                    default:
                    case IRLib.AssinaturaTipo.EnumPeriodos.ForaDePeriodo:
