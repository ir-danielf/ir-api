using CTLib;
using IRLib.ClientObjects.Assinaturas.Filarmonica;
using System;
...
namespace IRLib.Assinaturas
{
    public class Gerenciador
    {
        ...
        {
            IRLib.Sitef sitef = new IRLib.Sitef();
            ...
            try
            {
                ...
                if (precisaPagar)
                {
                    ...
                    sitef.Terminal = IRLib.Sitef.enumTerminal.SiteIR;
                    sitef.Empresa = IRLib.Sitef.enumEmpresa.IngressoRapido;
                    ...
                    sitef.TipoFinanciamento = IRLib.Sitef.enumTipoFinanciamento.Estabelecimento;
                    sitef.IniciaSitef();
