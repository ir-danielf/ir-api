...
using CTLib;
using IRLib.ClientObjects.Assinaturas;
using System;
...
namespace IRLib
{
    ...
    public class AssinaturaAcaoProvisoria : AssinaturaAcaoProvisoria_B
    {
        ...
        public List<IRLib.Assinaturas.Models.AcaoProvisoria> BuscarLista(int ClienteID, bool processado)
        {
            try
            {
                string sql =
                ...
                List<IRLib.Assinaturas.Models.AcaoProvisoria> lista = new List<IRLib.Assinaturas.Models.AcaoProvisoria>();
                do
                {
                    lista.Add(new IRLib.Assinaturas.Models.AcaoProvisoria()
                    {
                        ...
                        Acao = (IRLib.AssinaturaCliente.EnumAcao)Convert.ToChar(bd.LerString("Acao")),
                        Valor = bd.LerDecimal("Valor"),
                        PrecoTipoID = bd.LerInt("PrecoTipoID"),
                        Status = (IRLib.AssinaturaCliente.EnumStatus)Convert.ToChar(bd.LerString("Status")),
