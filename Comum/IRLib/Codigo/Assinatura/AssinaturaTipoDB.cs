...
namespace IRLib
{
    ...
    public abstract class AssinaturaTipo_B : BaseBD
    {
        ...
        public ativaBancoIngresso AtivaBancoIngresso = new ativaBancoIngresso();
        ...
        public override void Ler(int id)
        {
            ...
            try
            {
                ...
                //string sql = "SELECT * FROM tAssinaturaTipo (NOLOCK) WHERE ID = " + id;
                string sql = @"SELECT tAssinaturaTipo.* ,
                            tAssinaturaTexto.PaginaPrincipal AS PaginaPrincipalN, 
                            tAssinaturaTexto.PaginaLogin AS PaginaLoginN,
                            tAssinaturaTexto.Termos AS TermosN, tAssinaturaTexto.PaginaRodape AS PaginaRodapeN
                            FROM tAssinaturaTipo (NOLOCK)
                                INNER JOIN tAssinatura ON tAssinatura.AssinaturaTipoID = tAssinaturaTipo.ID
                            ...
                            WHERE tAssinaturaTipo.ID = "+id.ToString()+@" AND tAssinaturaTexto.AssinaturaAnoID IS NOT NULL
                            ORDER BY tAssinaturaTexto.AssinaturaFaseID";
                bd.Consulta(sql);
                ...
                if (bd.Consulta().Read())
                {
                    ...
                    this.Termos.ValorBD = bd.LerString("TermosN");
                    this.PaginaPrincipal.ValorBD = bd.LerString("PaginaPrincipalN");
                    this.PaginaLogin.ValorBD = bd.LerString("PaginaLoginN");
                    this.PaginaRodape.ValorBD = bd.LerString("PaginaRodapeN");
                    ...
                    this.AtivaBancoIngresso.ValorBD = bd.LerString("AtivaBancoIngresso");
                }
                else
                {
                    sql = "SELECT * FROM tAssinaturaTipo (NOLOCK) WHERE ID = " + id;
                    bd.Consulta(sql);
        ...
        public void Ler(int id, IRLib.Assinaturas.Models.Fase fase)
        {

            try
            {
                int idFase = 0;
                if (fase.FaseAssinatura == IRLib.Utils.Enums.EnumFaseAssinatura.Renovacao)
                    idFase = 1;
                else if (fase.FaseAssinatura == IRLib.Utils.Enums.EnumFaseAssinatura.TrocaPrioritaria)
                    idFase = 2;
                else if (fase.FaseAssinatura == IRLib.Utils.Enums.EnumFaseAssinatura.Troca)
                    idFase = 3;
                else if (fase.FaseAssinatura == IRLib.Utils.Enums.EnumFaseAssinatura.Aquisicoes)
                    idFase = 4;
                ...
                string sql = @"SELECT tAssinaturaTipo.* ,
                            ...
                            AND tAssinaturaTexto.AssinaturaFaseID = {1}";
                bd.Consulta(string.Format(sql, id, idFase));
        ...
        public class ativaBancoIngresso : TextProperty
        {
