...
namespace IRLib
{
    ...
    public class ConfigGerenciador : MarshalByRefObject
    {
        ...
        public int getFormaPagamentoIDCortesia()
        {
            return Convert.ToInt32(ConfigurationManager.AppSettings["FormaPagamentoIDCortesia"]);
        }

        public int getEntregaControleIDMobileTicket()
        {
            return Convert.ToInt32(ConfigurationManager.AppSettings["EntregaControleIDMobileTicket"]);
        }

        public List<String> getIPsWhiteListPagamentoExterno()
        {
            var ids = ConfigurationManager.AppSettings["IPsWhiteListPagamentoExterno"];

            return ids.Split(',').ToList();
        }

        public bool getAtivaIPsWhiteList()
        {
            var verificaIPsWhiteList = ConfigurationManager.AppSettings["AtivaIPsWhiteList"];

            return Convert.ToBoolean(verificaIPsWhiteList);
        }

        public List<int> getEntregaControleIDGeraCodigoBarra()
        {
            var ids = ConfigurationManager.AppSettings["EntregaControleIDGeraCodigoBarra"];
        ...
        public List<int> getMobileCanais()
        {
            var ids = ConfigurationManager.AppSettings["CanaisMobile"];
        ...
        public List<int> getSpecialEventIDs()
        {
            try
            {
                ...
                string specialIDS = Configuracao.GetString(Configuracao.Keys.SpecialEventsID, ConfigurationManager.AppSettings["ConfigVersion"]);
        ...
        public string getCanaisMobileID()
        {
            return ConfigurationManager.AppSettings["CanaisMobile"];
        }
        ...
        public string getChaveConfig(string nomeChave)
        {
            return Convert.ToString(ConfigurationManager.AppSettings[nomeChave]);
        }
    }
}
