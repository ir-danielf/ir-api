...
namespace IRLib
{
    ...
    public class FormaPagamentoTipo : FormaPagamentoTipo_B
    {
        ...
        public List<IRLib.ClientObjects.EstruturaIDNome> CarregarLista(string registroZero)
        {
         
            List<IRLib.ClientObjects.EstruturaIDNome> listaEstrutura = new List<IRLib.ClientObjects.EstruturaIDNome>();
