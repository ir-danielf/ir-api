...
namespace IRLib.Willcall
{
    ...
    public class Gerenciador : MarshalByRefObject
    {
        ...
        public List<string> GerarCodigoBarra(List<KeyValuePair<int, int>> listaChave, int eventoID)
        {
            ...
            IRLib.IngressoCodigoBarra oIngressoCodigoBarra;
            IRLib.CodigoBarra oCodigoBarra = new IRLib.CodigoBarra();
            ...
            foreach (KeyValuePair<int, int> item in listaChave)
            {
                ...
                oIngressoCodigoBarra = new IRLib.IngressoCodigoBarra();
        ...
        public void AtualizarStatusIngressoImpresso(int id)
        {
            ...
            query.Replace("@001", IRLib.Ingresso.IMPRESSO);
