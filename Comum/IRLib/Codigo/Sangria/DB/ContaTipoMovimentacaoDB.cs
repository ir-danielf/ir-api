...
namespace IRLib
{
    public class ContaTipoMovimentacao_B : BaseBD
    {
        ...
        public override void Ler(int id)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM ContaTipoMovimentacao WHERE ID = " + id;
                bd.Consulta(sql);
        ...
        public override bool Excluir(int id)
        {
            try
            {
                ...
                string sqlDelete = "DELETE FROM ContaTipoMovimentacao WHERE ID=" + id;
