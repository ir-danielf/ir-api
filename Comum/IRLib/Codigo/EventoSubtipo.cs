...
namespace IRLib
{
    ...
    public class EventoSubtipo : EventoSubtipo_B
    {
        ...
        public DataTable CarregarPorTipoId(Int32 tipoId)
        {
            try
            {
                ...
                string sql = "SELECT ID, EventoTipoID, Descricao FROM tEventoSubtipo WHERE EventoTipoId = @EventoTipoId ORDER BY Descricao";

                List<SqlParameter> parametros = new List<SqlParameter>();
                parametros.Add(new SqlParameter("@EventoTipoId", tipoId));
