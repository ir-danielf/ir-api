...
namespace IRLib
{
    ...
    public class VendaBilheteriaFormaPagamentoBoleto : VendaBilheteriaFormaPagamentoBoleto_B
    {
        ...
        {
            DateTime vencimentoBoleto = DateTime.Now.AddMonths(-1).AddDays(IRLib.Boleto.Instancia.Info.DiasPrimeiroVencimento.Valor);
        ...
        public void Reemitir()
        {
            try
            {
                ...
                this.DataVencimento.Valor = DateTime.Now.Date.AddDays(IRLib.Boleto.Instancia.Info.DiasPrimeiroVencimento.Valor);
                this.Inserir(bd);
