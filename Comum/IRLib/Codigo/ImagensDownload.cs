...
namespace IRLib
{
    ...
    [JirayaObject]
    public class ImagensDownload : MarshalByRefObject
    {
            ...
            try
            {
                ...
                switch (tipoDownload)
                {
                    ...
                    case ImagensGerenciarServidor.Tipo.EventoPos:
                        ...
                        break;
                    case ImagensGerenciarServidor.Tipo.ElementoMapa:
                        Path = ConfigurationManager.AppSettings["DownloadPathElementoMapa"];
                        break; 
                }
        ...
        public static void Download(ImagensGerenciarServidor.Tipo tipoDownload, string dirTemp, string nomeArquivo, string extensao, string pastaDestinoLocal)
        {
            try
            {
                ...
                ImagensDownload getPath = new ImagensDownload();
