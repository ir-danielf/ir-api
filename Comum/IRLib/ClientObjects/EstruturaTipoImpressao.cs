...
namespace IRLib.ClientObjects
{
    ...
    public class EstruturaTipoImpressao
    {
        ...
        public static List<EstruturaTipoImpressao> TiposImpressao()
        {
            ...
            lista.Add(
                new EstruturaTipoImpressao() { Tipo = (char)TipoImpressao.Argox, Nome = "Argox" });
            return lista;
        }

        public static char ToTipo(bool termica, bool laser, bool argox)
        {
            if (termica && laser)
                ...
                return (char)TipoImpressao.Argox;
            else
