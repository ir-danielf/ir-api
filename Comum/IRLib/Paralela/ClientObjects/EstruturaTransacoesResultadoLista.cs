    ...
    public class EstruturaTransacoesResultadoLista : List<EstruturaTransacoesResultado>
    {
        ...
        public string MontarFiltroTransacoes()
        {
            ...
            else
            {
                ...
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Visa + ", ");
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Mastercard + ", ");
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Amex + ", ");
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Aura + ", ");
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Diners + ", ");
                stbSQL.Append((int)IRLib.Paralela.Cartao.enumBandeira.Hipercard + ") ");
            }
