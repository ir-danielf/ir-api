    ...
    public class Caixa : Caixa_B
    {
        ...
        public override bool Aberto(int usuarioid, int lojaid)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tCaixa WHERE DataFechamento='' AND UsuarioID=" + usuarioid;
        ...
        {
            List<ClientObjects.EstruturaFechamentoCaixa> listaCaixas = new List<IRLib.Paralela.ClientObjects.EstruturaFechamentoCaixa>();
            ...
            try
            {
                    ...
                    "	tCaixa.ID "))
                {
                    while (oDataReader.Read())
                    {
                        oCaixa = new IRLib.Paralela.ClientObjects.EstruturaFechamentoCaixa();
