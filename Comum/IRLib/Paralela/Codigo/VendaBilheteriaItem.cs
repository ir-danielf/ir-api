...
namespace IRLib.Paralela
{
    ...
    public class VendaBilheteriaItem : VendaBilheteriaItem_B
    {
        ...
        public IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento TipoPagamento(int vendaBilheteriaItemID)
        {
            BD bd = new BD();
            try
            {
                ...
                switch (notaFiscal)
                {
                    case IRLib.AdyenStatic.Fields.NotaFiscal:
                        return IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento.Adyen;
                    case IRLib.AdyenStatic.Fields.NotaFiscalPaypal:
                        return IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento.Paypal;
                    case IRLib.AdyenStatic.Fields.NotaFiscalMilhas:
                        return IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento.Milhas;
                    case "":
                        return IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento.Nenhum;
                    default:
                        return IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento.TEF;
                }
            }
            finally
            {
        ...
        public IRLib.Paralela.ClientObjects.EstruturaPagamento.enumTipoPagamento TipoPagamentoBilheteria(int vendaBilheteriaID)
        {
            BD bd = new BD();
            try
            {
