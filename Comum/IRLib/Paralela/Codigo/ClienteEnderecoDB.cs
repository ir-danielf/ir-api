    ...
    public abstract class ClienteEndereco_B : BaseBD
    {
        ...
        public override bool Inserir()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("SELECT MAX(ID) AS ID FROM cClienteEndereco");
                ...
                sql.Append("INSERT INTO tClienteEndereco(ID, ClienteID, CEP, Endereco, Numero, Cidade, Estado, Complemento, Bairro, Nome, CPF, RG, EnderecoTipoID, EnderecoPrincipal, StatusConsulta) ");
