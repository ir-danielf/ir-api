...
namespace IRLib.Paralela
{
    ...
    public class ClienteEndereco : ClienteEndereco_B
    {
        ...
        public IRLib.Paralela.Codigo.Brainiac.Retorno CadastroValido(string cpf, string nome, enumStatusCPF status)
        {
        ...
        public IRLib.Paralela.Codigo.Brainiac.Retorno ConsultaCPF(string CPF, string nome)
        {
            try
            {
