        ...
        public bool PossuiClienteAssinaturaAno(int ano, int assinaturaID)
        {
            ...
            try
            {
                string sql = @"SELECT TOP 1 tAssinaturaAno.ID 
                                ...
                                @"('" + IRLib.Paralela.Utils.Enums.GetChar(AssinaturaCliente.EnumAcao.Renovar) + "', '" + IRLib.Paralela.Utils.Enums.GetChar(AssinaturaCliente.EnumAcao.EfetivarTroca) + "', '" + IRLib.Paralela.Utils.Enums.GetChar(AssinaturaCliente.EnumAcao.Aquisicao) + "')";
