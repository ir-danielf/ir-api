...
namespace IRLib.Paralela.Assinaturas.Relatorios
{
    public class TotalAssinaturasSerie
    {
        ...
        public TabelaTotalAssinaturasSerie BuscarRelatorio(int AssinaturaTipoID, string ano)
        {
            try
            {
                IRLib.Paralela.Assinatura oAssinatura = new Assinatura();
                ...
                do
                {
                    aux = new Models.TotalAssinaturasSerie()
                    {
                        ...
                        Status = bd.LerString("StatusIngresso") == "" && bd.LerString("StatusAssinatura") == "" && bd.LerString("AcaoAssinatura") == "" ? IRLib.Paralela.Assinatura.EnumStatusVisual.Indisponivel : oAssinatura.VerificaStatusVisual(bd.LerString("StatusIngresso"), bd.LerString("StatusAssinatura"), bd.LerString("AcaoAssinatura"), bd.LerInt("IngressoBloqueioID"), bd.LerInt("AssinaturaBloqueioID"), bd.LerInt("AssinaturaExtintoBloqueioID"), bd.LerInt("AssinaturaDesistenciaBloqueioID")),
