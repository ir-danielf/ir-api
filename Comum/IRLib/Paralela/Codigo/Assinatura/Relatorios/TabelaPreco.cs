...
namespace IRLib.Paralela.Assinaturas.Relatorios
{
    public class TabelaPreco
    {
        ...
        public List<TabelaPrecoVisu> BuscarRelatorio(int AssinaturaTipoID)
        {
            try
            {
                ...
                string sqlBusca =
                   string.Format(@"select Assinatura,Setor,Preco as PrecoTipo,Valor as Preco 
                                   from vwAssinaturaPagamento 
                                   where AssinaturaTipoID = {0}
                                   ...
                                   OR ( Acao = 'E' AND ac.Status = 'T' )) And vwa.AssinaturaTipoID = {0} AND tvb.VendaCancelada = 'F'
