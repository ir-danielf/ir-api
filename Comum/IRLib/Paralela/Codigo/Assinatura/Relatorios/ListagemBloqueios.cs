...
namespace IRLib.Paralela.Assinaturas.Relatorios
{
    public class ListagemBloqueios
    {
        ...
        public IRLib.Paralela.Assinatura.EnumStatusVisual VerificaStatusVisual(string statusIngresso, string statusAssinatura, string acaoAssinatura, int ingressoBloqueioID, int assinaturaBloqueioID, int assinaturaExtintoBloqueioID, int assinaturaDesistenciaBloqueioID)
        {
            try
            {
                IRLib.Paralela.Assinatura.EnumStatusVisual statusRetorno;

                if ((Ingresso.StatusIngresso)Convert.ToChar(statusIngresso) == Ingresso.StatusIngresso.RESERVADO)
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Reservando;
                }
                else if ((Ingresso.StatusIngresso)Convert.ToChar(statusIngresso) == Ingresso.StatusIngresso.DISPONIVEL)
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Disponivel;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Extinto;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Bloqueado;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Indisponivel;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.AguardandoAcao;
                }
                else if ((AssinaturaCliente.EnumStatus)Convert.ToChar(statusAssinatura) == AssinaturaCliente.EnumStatus.Indisponivel && (Ingresso.StatusIngresso)Convert.ToChar(statusIngresso) == Ingresso.StatusIngresso.BLOQUEADO && (AssinaturaCliente.EnumAcao)Convert.ToChar(acaoAssinatura) == AssinaturaCliente.EnumAcao.AguardandoAcao && ingressoBloqueioID == assinaturaExtintoBloqueioID)
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.AguardandoAcaoExtinto;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.AguardandoAcaoPrioritaria;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.AguardandoAcaoAdministrativa;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.TrocaSinalizada;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Renovado;
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.RenovadoSemPagamento;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Comprado;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.TrocaEfetuada;
                }
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Emitido;
                ...
                {
                    statusRetorno = IRLib.Paralela.Assinatura.EnumStatusVisual.Entregue;
            ...
            return IRLib.Paralela.Assinatura.EnumStatusVisual.AguardandoAcao;
        }


        public List<IRLib.Paralela.Assinaturas.Models.ListagemBloqueios> BuscarRelatorio(int AssinaturaTipoID, int Temporadas, int Assinaturas)
        {
            try
            {
                ...
                while (bd.Consulta().Read())
                {
                    ...
                    {
                        eABaux.Status = IRLib.Paralela.Assinatura.EnumStatusVisual.Indisponivel;
