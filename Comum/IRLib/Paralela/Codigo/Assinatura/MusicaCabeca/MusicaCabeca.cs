...
namespace IRLib.Paralela
{
    ...
    public class MusicaCabeca : MusicaCabeca_B
    {
        ...
        public List<Assinaturas.Models.MusicaCabeca> ListaEventos(int clienteID)
        {
            try
            {
                List<IRLib.Paralela.Assinaturas.Models.MusicaCabeca> lista = new List<Assinaturas.Models.MusicaCabeca>();
                List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaMusicaCabeca> lstInscritos = new List<ClientObjects.Assinaturas.EstruturaMusicaCabeca>();
                ...
                while (bd.Consulta().Read())
                {
                    ...
                    lista.Add(new IRLib.Paralela.Assinaturas.Models.MusicaCabeca()
                    {
                        ID = bd.LerInt("ID"),
                ...
                while (bd.Consulta().Read())
                    lstInscritos.Add(new IRLib.Paralela.ClientObjects.Assinaturas.EstruturaMusicaCabeca()
                    {
        ...
        public Assinaturas.Models.MusicaCabeca VerificaEvento(int id)
        {
            try
            {
                IRLib.Paralela.Assinaturas.Models.MusicaCabeca mMusicaCabeca = new Assinaturas.Models.MusicaCabeca();
        ...
        public List<Assinaturas.Models.MusicaCabecaComprovantes> ListaEventosInscritos(int clienteID)
        {
            try
            {
                ...
                List<IRLib.Paralela.Assinaturas.Models.MusicaCabecaComprovantes> lista = new List<Assinaturas.Models.MusicaCabecaComprovantes>();
                ...
                while (bd.Consulta().Read())
                {
                    ...
                    lista.Add(new IRLib.Paralela.Assinaturas.Models.MusicaCabecaComprovantes()
                    {
                        ID = bd.LerString("ID"),
                        Nome = bd.LerString("Nome").ToUpper(),
        ...
        public List<Assinaturas.Models.MusicaCabecaInscito> ListaInscritos(int MusicaCabecaID)
        {
            try
            {
                ...
                List<IRLib.Paralela.Assinaturas.Models.MusicaCabecaInscito> lista = new List<Assinaturas.Models.MusicaCabecaInscito>();
                ...
                while (bd.Consulta().Read())
                {
                    lista.Add(new IRLib.Paralela.Assinaturas.Models.MusicaCabecaInscito()
                    {
                        ID = bd.LerString("ID"),
                        Nome = bd.LerString("Nome").ToUpper(),
        ...
        public List<Assinaturas.Models.MusicaCabecaAgregado> ListaAgregados(int MusicaCabecaID, int clienteID)
        {
            try
            {
                ...
                List<IRLib.Paralela.Assinaturas.Models.MusicaCabecaAgregado> lista = new List<Assinaturas.Models.MusicaCabecaAgregado>();
                ...
                while (bd.Consulta().Read())
                {
                    lista.Add(new IRLib.Paralela.Assinaturas.Models.MusicaCabecaAgregado()
                    {
        ...
        public bool VerificaVaga(int musicaCabecaID, bool assinante)
        {
            try
            {
                IRLib.Paralela.Assinaturas.Models.MusicaCabeca Evento = new Assinaturas.Models.MusicaCabeca();
                List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaMusicaCabeca> lstInscritos = new List<ClientObjects.Assinaturas.EstruturaMusicaCabeca>();
                ...
                {
                    DateTime dataEvento = bd.LerDateTime("Data");
                    Evento = new IRLib.Paralela.Assinaturas.Models.MusicaCabeca()
                    {
                        ID = bd.LerInt("ID"),
                        Nome = bd.LerString("Nome").ToUpper(),
                        Local = bd.LerString("Local"),
