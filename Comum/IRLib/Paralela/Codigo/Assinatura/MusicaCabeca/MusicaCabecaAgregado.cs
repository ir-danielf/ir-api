    ...
    public class MusicaCabecaAgregado : MusicaCabecaAgregado_B
    {
        ...
        public Assinaturas.Models.MusicaCabecaComprovantes CarregarComprovante(int MusicaCabecaAgregadoID)
        {
            try
            {
                ...
                IRLib.Paralela.Assinaturas.Models.MusicaCabecaComprovantes retorno = new Assinaturas.Models.MusicaCabecaComprovantes();
                ...
                while (bd.Consulta().Read())
                {
                    ...
                    retorno = new IRLib.Paralela.Assinaturas.Models.MusicaCabecaComprovantes()
                     {
                         ID = bd.LerString("ID"),
