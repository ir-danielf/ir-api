...
namespace IRLib.Paralela
{
    ...
    public class AssinaturaItem : AssinaturaItem_B
    {
        ...
        public List<SetorInfo> BuscaSetoresEsquematico(int assinaturaID, int ano, IRLib.Paralela.SingleTonObjectsParalela singleTon, ref int mapaEsquematicoID)
        {
            return BuscaSetoresEsquematico(assinaturaID, ano, singleTon, ref mapaEsquematicoID, 0, false);
        }

        public List<SetorInfo> BuscaSetoresEsquematico(int assinaturaID, int ano, IRLib.Paralela.SingleTonObjectsParalela singleTon, ref int mapaEsquematicoID, int apresentacaoID, bool bancoIngresso)
        {
            try
            {
                string sql =
