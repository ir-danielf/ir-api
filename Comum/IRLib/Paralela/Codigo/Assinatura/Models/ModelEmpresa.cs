...
namespace IRLib.Paralela.Assinaturas.Models
{
    public class ModelEmpresa
    {
        ...
        public void Carregar(int Id)
        {
            ...
            try
            {
                string query = @"Select NomeFantasia, RazaoSocial, CNPJ, Endereco, CEP, Bairro, Telefone1, Telefone2, Fax, Info, Politicas
                                from assinaturaInfoSite where IDTipoASsinatura = " + Id;
