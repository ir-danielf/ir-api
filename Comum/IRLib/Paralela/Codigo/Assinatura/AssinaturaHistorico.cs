...
namespace IRLib.Paralela
{
    ...
    public class AssinaturaHistorico : AssinaturaHistorico_B
    {
        ...
        public List<IRLib.Paralela.Assinaturas.Models.Historico> BuscarHistorico(int clienteID, int assinaturaTipoID, string clienteNome)
        {
            try
            {
                string sql =
                ...
                List<IRLib.Paralela.Assinaturas.Models.Historico> lista = new List<Assinaturas.Models.Historico>();
                do
                {
