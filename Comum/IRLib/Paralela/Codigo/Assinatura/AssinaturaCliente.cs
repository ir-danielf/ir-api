...
namespace IRLib.Paralela
{
    ...
    public class AssinaturaCliente : AssinaturaCliente_B
    {
        ...
        public IEnumerable<IRLib.Paralela.Assinaturas.Models.Assinatura> AssinaturasPorAcaoDoCliente(
            int assinaturaTipoID, int ano, int clienteID, EnumAcao acao, EnumStatus status, bool incluirIndisponiveis)
        {
            try
            {
                ...
                var lista = new List<IRLib.Paralela.Assinaturas.Models.Assinatura>();

                do
                {
                    lista.Add(new IRLib.Paralela.Assinaturas.Models.Assinatura()
                    {
        ...
        public IEnumerable<IRLib.Paralela.Assinaturas.Models.Assinatura> AssinaturasParaTrocarDoCliente(
        ...
        public IEnumerable<IRLib.Paralela.Assinaturas.Models.Aqusicao> AssinaturasDoCliente(int assinaturaTipoID, int ano, int clienteID)
        {
            try
            {
                string sql =
                   string.Format(@"SELECT
							...
							ORDER BY a.Nome, s.Nome, l.Codigo
						 ", clienteID, assinaturaTipoID, ano, IRLib.Paralela.Utils.Enums.GetChar(EnumAcao.Desisistir));
                ...
                if (!bd.Consulta().Read())
                    return null;
                List<IRLib.Paralela.Assinaturas.Models.Aqusicao> lista = new List<Assinaturas.Models.Aqusicao>();
                do
                {
        ...
        public IRLib.Paralela.Assinaturas.Models.Aqusicao ProgramacaoAssinatura(int assinaturaID)
        {
            Assinatura oAssinatura = new Assinatura();
            string caminhoImg = new ConfigGerenciadorParalela().getDownloadPathAssinatura();
            string imgAssinatura = oAssinatura.GetNomeImg(assinaturaID);
            string caminhoTotal = caminhoImg + imgAssinatura;

            IRLib.Paralela.Assinaturas.Models.Aqusicao retorno = new Assinaturas.Models.Aqusicao()
                {
        ...
        public List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaAssinaturaPreco> BuscarPrecos(int assinaturaClienteID, int ano, string primeiro)
        {
        ...
        public List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaAssinaturaPreco> BuscarPrecos(int assinaturaClienteID, int ano)
        {
            try
            {
                string sql =
                ...
                List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaAssinaturaPreco> lista = new List<IRLib.Paralela.ClientObjects.Assinaturas.EstruturaAssinaturaPreco>();

                do
                {
                    lista.Add(new IRLib.Paralela.ClientObjects.Assinaturas.EstruturaAssinaturaPreco()
                    {
                        AssinaturaClienteID = assinaturaClienteID,
                        ID = bd.LerInt("ID"),
        ...
        public string Vender(int clienteID, int usuarioID, string formaPagamento, int Parcelas,
                            ...
                            EstruturaReservaInternet estruturaIdentificaoUsuario, List<IRLib.Paralela.Assinaturas.Models.AcaoProvisoria> listaAcoes,
        ...
        public string Vender(BD bd, int clienteID, int usuarioID, string formaPagamento, int Parcelas,
                    ...
                    decimal desconto, int entregaID, decimal valorEntrega, bool valorEntregaFixo, int SenhaID, string email)
        {
            IRLib.Paralela.Sitef oSitef = new IRLib.Paralela.Sitef();
            ...
            try
            {
                ...
                EstruturaVendaFormaPagamento oFormaPagamento = new IRLib.Paralela.FormaPagamento().getFormaPagamentoVendaAssinatura(formaPagamento, Parcelas, estruturaIdentificaoUsuario.EmpresaID, clienteID, usuarioID);
                ...
                if (utilizarTef)
                {
                    ...
                    oSitef.Terminal = IRLib.Paralela.Sitef.enumTerminal.SiteIR;
                    oSitef.Empresa = IRLib.Paralela.Sitef.enumEmpresa.IngressoRapido;
                    ...
                    oSitef.TipoFinanciamento = IRLib.Paralela.Sitef.enumTipoFinanciamento.Estabelecimento;
                    oSitef.IniciaSitef();
                ...
                oVendaBilheteira.PagamentoProcessado.Valor = oFormaPagamento.Tipo != (int)IRLib.Paralela.FormaPagamento.TIPO.Boleto;
                ...
                if (valorTotal > 0)
                {
                    ...
                    if (oFormaPagamento.Tipo == (int)IRLib.Paralela.FormaPagamento.TIPO.Boleto)
                ...
                if (desconto > 0 && valorTotal > 0)
                {
                    ...
                    oFormaPagamento = new IRLib.Paralela.FormaPagamento().getFormaPagamentoVenda(FormaPagamento.DESCONTO_ID, estruturaIdentificaoUsuario.EmpresaID);
                    oVendaBilheteriaFormaPagamento.Dias.Valor = oFormaPagamento.Dias;
                    oVendaBilheteriaFormaPagamento.FormaPagamentoID.Valor = oFormaPagamento.FormaPagamentoID;
                    oVendaBilheteriaFormaPagamento.IR.Valor = oFormaPagamento.IR;
                    oVendaBilheteriaFormaPagamento.TaxaAdm.Valor = oFormaPagamento.TaxaAdm;
        ...
        public void Reservar(BD bd, int clienteID, int assinaturaID, int setorID, int lugarID, int ano, EstruturaReservaInternet estruturaIdentificacaoUsuario, int relacionadoAssinaturaClienteID)
        {
            ...
            new BilheteriaParalela().ReservarAssinatura(bd,
        ...
        public IRLib.Paralela.Assinaturas.Models.Assinatura BuscaAssinatura(int clienteID, int assinaturaClienteID)
        {
            try
            {
                string sql =
                ...
                return new IRLib.Paralela.Assinaturas.Models.Assinatura()
                {
                    Nome = bd.LerString("Assinatura"),
                    Setor = bd.LerString("Setor"),
        ...
        public List<IRLib.Paralela.Assinaturas.Models.Cliente> BuscarClientesPaginado(
            ...
            string login, string assinante, string CPF, int qtdPorPagina, ref List<int> paginas, int pagina)
        {
            try
            {
                List<IRLib.Paralela.Assinaturas.Models.Cliente> lista = new List<Assinaturas.Models.Cliente>();
        ...
        public List<IRLib.Paralela.Assinaturas.Models.Cliente> BuscarClientes(
             int assinaturaTipoID, int ano, int assinaturaID, int setorID, string statusLugar, string statusBoleto, string vencMin, string vencMax,
            ...
            string login, string assinante, string CPF)
        {
            ...
            if (!string.IsNullOrEmpty(statusLugar) && statusLugar != "S")
                stb.Append(Assinatura.DesmembrarStatus(IRLib.Paralela.Utils.Enums.ParseItem<IRLib.Paralela.Assinatura.EnumStatusVisual>(statusLugar)));
