                ...
                if (this.bomCliente > 0 || this.blackList > 0 || this.BuscaTipo > 0 || !string.IsNullOrEmpty(this.BuscaTexto))
                {
                    ...
                    switch (this.blackList)
                    {
                        case 1:
                            ...
                            {
                                sql.Append("StatusAtual = '" + (char)IRLib.Paralela.Cartao.enumStatusCartao.Bloqueado + "' AND ");
                            }
                            else
                            {
                                sql.Append("StatusAtual = '" + (char)IRLib.Paralela.Cartao.enumStatusCartao.Bloqueado + "' ");
                            }
                            break;
                        case 2:
                            if (this.bomCliente > 0)
                            {
                                sql.Append("StatusAtual = '" + (char)IRLib.Paralela.Cartao.enumStatusCartao.Liberado + "' AND ");
                            }
                            else
                            {
                                sql.Append("StatusAtual = '" + (char)IRLib.Paralela.Cartao.enumStatusCartao.Liberado + "' ");
                            }
