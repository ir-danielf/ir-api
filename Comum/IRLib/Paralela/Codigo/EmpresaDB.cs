	...
	public abstract class Empresa_B : BaseBD {
		...
		protected void InserirLog(){
			...
			try{
				...
				sql.Append("INSERT INTO xEmpresa (ID, Versao, RegionalID, Nome, ContatoNome, ContatoCargo, Endereco, Cidade, Estado, CEP, DDDTelefone, Telefone, DDDFax, Fax, EmpresaPromove, EmpresaVende, Email, Website, Obs, TaxaMaximaEmpresa, BannerPadraoSite) ");
				sql.Append("SELECT ID, @V, RegionalID, Nome, ContatoNome, ContatoCargo, Endereco, Cidade, Estado, CEP, DDDTelefone, Telefone, DDDFax, Fax, EmpresaPromove, EmpresaVende, Email, Website, Obs, TaxaMaximaEmpresa, BannerPadraoSite FROM tEmpresa WHERE ID = @I");
		...
		public override bool Inserir(){
			...
			try{
				...
				sql.Append("INSERT INTO tEmpresa(ID, RegionalID, Nome, ContatoNome, ContatoCargo, Endereco, Cidade, Estado, CEP, DDDTelefone, Telefone, DDDFax, Fax, EmpresaPromove, EmpresaVende, Email, Website, Obs, TaxaMaximaEmpresa, BannerPadraoSite) ");
		...
		public override bool Atualizar(){
			...
			try{
				...
				StringBuilder sql = new StringBuilder();
				sql.Append("UPDATE tEmpresa SET RegionalID = @001, Nome = '@002', ContatoNome = '@003', ContatoCargo = '@004', Endereco = '@005', Cidade = '@006', Estado = '@007', CEP = '@008', DDDTelefone = '@009', Telefone = '@010', DDDFax = '@011', Fax = '@012', EmpresaPromove = '@013', EmpresaVende = '@014', Email = '@015', Website = '@016', Obs = '@017', TaxaMaximaEmpresa = '@018', BannerPadraoSite = '@019' ");
