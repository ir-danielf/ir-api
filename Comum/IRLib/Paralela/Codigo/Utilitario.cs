...
namespace IRLib.Paralela
{
    ...
    public sealed class Utilitario
    {
        ...
        //		public const string FormatoMoeda = "C";
        ...
        /// <summary>
        /// Retorna uma string concatenada com os ids separados por virgula
        /// </summary>
        ...
        /// <summary>
        ///  Retorna uma string concatenada com os codigos separados por virgula
        /// </summary>
        /// <param name="array"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Método que compara duas string, desconsiderando se são maiúsculas, minúsculas e respectivos acentos.
        /// </summary>
        /// <param name="a">Primeira string a ser comparada.</param>
        /// <param name="b">Segunda string a ser comparada.</param>
        /// <returns>Iguais = 0</returns>
        ...
        /// <summary>
        /// Enviar a string XML como INNERXML
        /// </summary>
        ...
        public static string HTTPPostXML(string url, string xml, string usuario, string senha)
        {
            ...
            //string credentials = String.Format("{0}:{1}", "ingresso.test.import", "48Dxnh1Q");
    ...
    public static class ExtensionsIRLib
    {
        ...
        static string[] acentos = new string[] { "ç", "Ç", "á", "é", "í", "ó", "ú", "ý", "Á", "É", "Í", "Ó", "Ú", "Ý", "à", "è", "ì", "ò", "ù", "À", "È", "Ì", "Ò", "Ù", "ã", "õ", "ñ", "ä", "ë", "ï", "ö", "ü", "ÿ", "Ä", "Ë", "Ï", "Ö", "Ü", "Ã", "Õ", "Ñ", "â", "ê", "î", "ô", "û", "Â", "Ê", "Î", "Ô", "Û" };
        static string[] semAcento = new string[] { "c", "C", "a", "e", "i", "o", "u", "y", "A", "E", "I", "O", "U", "Y", "a", "e", "i", "o", "u", "A", "E", "I", "O", "U", "a", "o", "n", "a", "e", "i", "o", "u", "y", "A", "E", "I", "O", "U", "A", "O", "N", "a", "e", "i", "o", "u", "A", "E", "I", "O", "U" };

        public static string ToCleanString(this object valor)
        {
            try
            {
                ...
                for (int i = 0; i < acentos.Length; i++)
                    val = val.Replace(acentos[i], semAcento[i]);
        ...
        public static string AsCEP(this object valor)
        {
            try
            {
                ...
                string val = valor.ToString().ToCleanString();
