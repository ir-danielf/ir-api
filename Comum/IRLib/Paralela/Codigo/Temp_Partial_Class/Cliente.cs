...
namespace IRLib.Paralela
{
    public partial class Cliente
    {
        ...
        public IRLib.Paralela.Codigo.Brainiac.Retorno ConsultaCPF(string CPF, string nome, ref string nomeRet)
        {
            try
            {
                IRLib.Paralela.Utilitario Utilitario = new Utilitario();
                ...
                * ¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨-¨
                ...
                if (nomeRet.StartsWith("*"))
                    return new IRLib.Paralela.Codigo.Brainiac.Retorno()
                    {
                        TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Parcial,
                        Mensagem = "Falha na Consulta."
                    };

                // Verifica se o nome digitado pelo cliente é igual ao retornado na consulta.
                return
                    new IRLib.Paralela.Codigo.Brainiac.Gerenciador()
            ...
            catch (WebException)
            {
                return new IRLib.Paralela.Codigo.Brainiac.Retorno()
                {
                    TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.ImplicarErro,
                    Mensagem = "Falha na Consulta."
                };
            }
        }
        ...
        public IRLib.Paralela.Codigo.Brainiac.Retorno CadastroValido()
        {
            if (!ValidacaoAtiva())
                return new IRLib.Paralela.Codigo.Brainiac.Retorno() { TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Ok };

            if (this.Pais.Valor != "Brasil")
                return new IRLib.Paralela.Codigo.Brainiac.Retorno() { TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Ok };

            if (this.CPF.Valor.Length == 0)
                return new IRLib.Paralela.Codigo.Brainiac.Retorno() { TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.ImplicarErro, Mensagem = "CPF Inválido." };
            ...
            IRLib.Paralela.Codigo.Brainiac.Retorno retornoBrainiac =
            ...
            {
                case IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Ok:
                    ...
                    break;
                case IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.ImplicarErro:
                    // cadastro inválido!
                    this.CPFConsultado.Valor = this.CPF.Valor;
                    this.NomeConsultado.Valor = retNomeConsultado;
                    ...
                    SalvarConsultaCPF(clienteID[1].ToString());
                    break;
                case IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Parcial:
                    break;
                default:
        ...
        public IRLib.Paralela.Codigo.Brainiac.Retorno CadastroEntregaValido()
        {
            if (!ValidacaoAtiva())
                return new IRLib.Paralela.Codigo.Brainiac.Retorno() { TipoRetorno = IRLib.Paralela.Codigo.Brainiac.Enumeradores.EnumTipoRetorno.Ok };
            ...
            IRLib.Paralela.Codigo.Brainiac.Retorno retornoBrainiac = null;
            ...
            {
                retornoBrainiac =
                    new IRLib.Paralela.Codigo.Brainiac.Gerenciador().IniciarNomes(this.Nome.Valor, this.NomeEntrega.Valor);
            ...
            switch (status)
            {
                ...
                case enumStatusCPF.Invalido:
                    ...
                    if (cpf.Equals(cpfConsultado) && nomeConsultado.Length > 0)
                    {
                        ...
                        return
                            new IRLib.Paralela.Codigo.Brainiac.Gerenciador().IniciarNomes(nomeConsultado, nome);
        ...
        public List<IRLib.Paralela.Assinaturas.Models.Cliente> BuscarClientesAssinatura(
