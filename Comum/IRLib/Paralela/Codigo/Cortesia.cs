...
namespace IRLib.Paralela
{
    ...
    public class Cortesia : Cortesia_B
    {
        ...
        private int CortesiaPadrao(int EventoID, int LocalID)
        {
            int retorno = 0;

            try
            {
                retorno = Convert.ToInt32(bd.ConsultaValor("" +
                    "SELECT " +
                    "	tCortesia.ID " +
                    "FROM " +
                    "	tCortesia (NOLOCK) " +
        ...
        public int CortesiaPadraoEvento(int EventoID)
        {
            return CortesiaPadrao(EventoID, 0);
        }
