...
namespace IRLib.Paralela
{
    ...
    public class CodigoBarra : CodigoBarra_B
    {
        ...
        public List<IRLib.Paralela.ClientObjects.EstruturaBlackList> BlackList(int eventoID, int apresentacaoID, int setorID)
        {
        ...
        /// <param name="setorID"></param>
        /// <returns>Lista de objetos EstruturaBlackList</returns>
        public List<IRLib.Paralela.ClientObjects.EstruturaBlackList> BlackList(int eventoID, int apresentacaoID, int setorID, DateTime ultimaSincronizacao)
        {
            //variável para controlar a mudança de ingressos dentro da lista
            int ingressoIDAnterior = 0;
            DateTime dataHoraAtual = DateTime.Now;
        ...
        {
            bool gerarcodigoAntigo = new ConfigGerenciadorParalela().GerarCodigoAntigo();
        ...
        public string NovoCodigoBarraListaBranca(BD bd, int ApresentacaoSetorID)
        {
            ...
            bd.Consulta().Close();
            bd.Executar("UPDATE tCodigoBarraEvento SET Utilizado = 'T' WHERE ID = " + id);
            return codigoBarra;

        }

        public bool AtualizaCodigoBarraListaBranca(BD bd, string CodigoBarra)
        {
            int x = bd.Executar("UPDATE tCodigoBarraEvento SET Utilizado = 'T' WHERE Codigo = '" + CodigoBarra + "'");
