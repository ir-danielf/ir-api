...
namespace IRLib.Paralela
{
    ...
    public class Canal : Canal_B
    {
        ...
        public static int CANAL_CALL_CENTER = new ConfigGerenciadorParalela().getCanalCallCenterID();
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE tCanal SET EmpresaID = @001, CanalTipoID = @002, Nome = '@003', TaxaConveniencia = @004, TaxaComissao = @005, TaxaMinima = '@006', TaxaMaxima = '@007', ComissaoMinima = '@008', ComissaoMaxima = '@009', ComprovanteQuantidade = @010, TipoVenda = '@011', OpcaoImprimirSemPreco = '@012', Cartao = '@013', NaoCartao = '@014', ObrigaCadastroCliente = '@015', Obs = '@016', Comissao = @017, PoliticaTroca = '@018', ConfirmacaoPorEmail = '@019', ObrigatoriedadeID = @020 , EnviaSms = '@021' , TEFF = '@022', NroEstabelecimento='@023' ");
        ...
        public List<EstruturaIDNome> CarregarCanaisVendaRemota(int EmpresaID, string CanaisID)
        {
            try
            {
                ...
                IRLib.Paralela.Canal canal = new Canal();
