...
namespace IRLib.Paralela
{
    ...
    public class Empresa : Empresa_B
    {
        ...
        {
            List<ClientObjects.EstruturaEmpresaConta> contas = new List<IRLib.Paralela.ClientObjects.EstruturaEmpresaConta>();
        ...
        public List<IRLib.Paralela.ClientObjects.EstruturaIDNome> CarregarLista(int regionalID, bool registroZero)
        {
            try
            {
