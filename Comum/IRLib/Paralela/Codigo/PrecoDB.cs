    ...
    public abstract class Preco_B : BaseBD
    {
        ...
        protected void InserirLog()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO xPreco (ID, Versao, Nome, CorID, PrecoTipoID, Valor, ApresentacaoSetorID, Quantidade, QuantidadePorCliente, Impressao, IRVende, ImprimirCarimbo, CarimboTexto1, CarimboTexto2, CodigoCinema) ");
                sql.Append("SELECT ID, @V, Nome, CorID, PrecoTipoID, Valor, ApresentacaoSetorID, Quantidade, QuantidadePorCliente, Impressao, IRVende, ImprimirCarimbo, CarimboTexto1, CarimboTexto2, CodigoCinema FROM tPreco WHERE ID = @I");
        ...
        public override bool Inserir()
        {
            ...
            try
            {
                ...
                sql.Append("INSERT INTO tPreco(ID, Nome, CorID, PrecoTipoID, Valor, ApresentacaoSetorID, Quantidade, QuantidadePorCliente, Impressao, IRVende, ImprimirCarimbo, CarimboTexto1, CarimboTexto2, CodigoCinema) ");
        ...
        public override bool Atualizar()
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE tPreco SET Nome = '@001', CorID = @002, PrecoTipoID = @003, Valor = '@004', ApresentacaoSetorID = @005, Quantidade = @006, QuantidadePorCliente = @007, Impressao = '@008', IRVende = '@009', ImprimirCarimbo = '@010', CarimboTexto1 = '@011', CarimboTexto2 = '@012', CodigoCinema = '@013' ");
