...
namespace IRLib.Paralela
{
    ...
    public class EventoTaxaEntrega : EventoTaxaEntrega_B
    {
        ...
        public List<string> DetalhesEntregaPorEventos(List<int> eventoIDs, int taxaEntregaID)
        {
            ...
            try
            {
                ...
                string sql = @"SELECT DISTINCT
                            ...
                            WHERE 
                            tEventoEntregaControle.EventoID IN ( " + Utilitario.ArrayToString(eventoIDs.ToArray()) + @") 
                            AND 
        ...
        public List<IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega> CarregarPorEvento(int eventoID)
        {
            try
            {
                List<IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega> lista = new List<IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega>();
                string sql =
                ...
                while (bd.Consulta().Read())
                {
                    lista.Add(new IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega()
                    {
                        EventoID = eventoID,
        ...
        public void Inserir(IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega editado)
        {
        ...
        public void Atualizar(IRLib.Paralela.ClientObjects.EstruturaEventoTaxaEntrega editado)
        {
