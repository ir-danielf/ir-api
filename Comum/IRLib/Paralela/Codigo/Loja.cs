...
namespace IRLib.Paralela
{
    ...
    public class Loja : Loja_B
    {
        ...
        public List<IRLib.Paralela.ClientObjects.EstruturaIDNome> ListaLojasInternet(int empresaID, int canalID)
        {
            List<IRLib.Paralela.ClientObjects.EstruturaIDNome> lista = new List<ClientObjects.EstruturaIDNome>();
        ...
        public List<EstruturaSelecaoArvoreLoja> Buscar(int empresaID, int canalID)
        {
            try
            {
                ...
                if (canalID > 0)
                    filtro = "WHERE c.ID = " + canalID;
                else if (empresaID > 0)
                    filtro = "WHERE em.ID = " + empresaID;
