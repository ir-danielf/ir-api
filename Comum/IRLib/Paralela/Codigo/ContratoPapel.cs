...
namespace IRLib.Paralela
{
    ...
    public class ContratoPapel : ContratoPapel_B
    {
        ...
        {
            List<ClientObjects.EstruturaContratoPapel> papeis = new List<IRLib.Paralela.ClientObjects.EstruturaContratoPapel>();
            ...
            try 
            {
                    ...
                    "	tContratoPapel.ContratoID = " + contratoID))
                {
                    ...
                    {
                        papel = new IRLib.Paralela.ClientObjects.EstruturaContratoPapel();
