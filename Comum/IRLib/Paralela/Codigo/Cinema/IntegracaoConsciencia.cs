...
namespace IRLib.Paralela.Cinema
{
    public class Erro
    {
    ...
    {
        private static IRLib.wsCinema.WSCinema wsCinema = new IRLib.wsCinema.WSCinema();

        private static IRLib.wsCinema.CINE_AUTENTICA GerarAutenticacao(Autenticacao auth)
        {
            return new IRLib.wsCinema.CINE_AUTENTICA()
            {
        ...
        public static List<Filme> getFilmes(Autenticacao autenticacao, Filtros.GetFilmes getFilmes)
        {
            var retorno = wsCinema.Get_Cinema_Filmes(GerarAutenticacao(autenticacao),
                new IRLib.wsCinema.CINE_GETFILMES()
            {
        ...
        public static List<Sala> getSalas(Autenticacao autenticacao, Filtros.GetSalas getSalas)
        {
            var retorno = wsCinema.Get_Cinema_Salas(Service.GerarAutenticacao(autenticacao),
                new IRLib.wsCinema.CINE_GETSALAS()
            {
        ...
        public static List<Programacao> getProgramacao(Autenticacao autenticacao, Filtros.GetProg getProg)
        {
            var retorno = wsCinema.Get_Cinema_Programacao(Service.GerarAutenticacao(autenticacao),
                new IRLib.wsCinema.CINE_GETPROG()
            {
        ...
        {
            var vagasProg = new IRLib.wsCinema.CINE_GETVAGASPROG[1];

            vagasProg[0] = new IRLib.wsCinema.CINE_GETVAGASPROG()
            {
        ...
        {
            var retorno = wsCinema.Get_Cinema_LugarProg(Service.GerarAutenticacao(autenticacao), new IRLib.wsCinema.CINE_GETLUGARPROG()
            {
        ...
        {
            var itens = new List<IRLib.wsCinema.CINE_VENDAITEM>();
            itens = (from i in venda.Itens
                     select new IRLib.wsCinema.CINE_VENDAITEM()
                     {
            ...
            var retorno = wsCinema.Set_Cinema_RealizaVenda(Service.GerarAutenticacao(autenticacao), new IRLib.wsCinema.CINE_VENDA()
            {
        ...
        {
            var retorno = wsCinema.Set_Cinema_CancelaVenda(Service.GerarAutenticacao(autenticacao), new IRLib.wsCinema.CINE_CANCVENDA()
            {
        ...
        public static void setReservaLugares(Autenticacao autenticacao, Filtros.SetReservaLugar[] setReservaLugar)
        {
            var ingressos = (from res in setReservaLugar
                             select new IRLib.wsCinema.CINE_SETRESERVALUGAR()
                             {
                                 IDPROG = res.IDProg,
                                 ACAO = res.Acao,
        ...
        public static List<Programacao> getProgramacoes(List<string> codigos)
        {
            ...
            {
                var lugarProgramacao = IRLib.Paralela.Cinema.Service.getProgramacao(IRLib.Paralela.Cinema.SincronizarCinemas.MontarAuth(), new Cinema.Filtros.GetProg()
                {
                    IDProg = programacao,
                });
